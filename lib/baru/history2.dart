...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void handleSlideIsOpenChanged(bool isOpen) {
    setState(() {
      Eazy.primary = isOpen ? Colors.green : Colors.blue;
    });
  }
  ...
  static String _getSubtitle(int index) {
    switch (index % 4) {
      case 0:
        return 'Jl. ABCD JAKARTA SELATAN';
      case 1:
        return 'Jl. EFGH Surabaya Jawa Timur';
      case 2:
        return 'Jl. ABCD Semarang Jawa Tengah';
      case 3:
        return 'Jl. EFGH Badung Bali';
      default:
        return null;
    }
  }

  static String _getTrailing(int index) {
    switch (index % 4) {
      case 0:
        return 'Waiting';
      case 1:
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Expanded(child: Text(item.trailing))
        ],
      ),
    );
  }
